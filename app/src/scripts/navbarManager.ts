...
class NavbarManager {
  ...
  onLoad() {
    ...
    this.registerListeners(navbarContainer)
  }

  registerListeners(navbarContainer: HTMLElement) {

    window.addEventListener("scroll", () => {
      navbarManager.toggleTransparent(navbarContainer);
    });
    navbarContainer.addEventListener("mouseover", () => {
      navbarManager.toggleTransparent(navbarContainer, false);
    });
    navbarContainer.addEventListener("mouseout", () => {
      navbarManager.toggleTransparent(navbarContainer, true);
    });
    navbarContainer.addEventListener("mousedown", () => {
      navbarManager.toggleTransparent(navbarContainer, false);
    });
    ...
    window.addEventListener("resize", () => {
      navbarManager.resize(navbarContainer);
    });
  }
  ...
  resize(navbarContainer: HTMLElement) {
    ...
    if (
      window.innerWidth <= parseInt(navbarContainer.dataset.mobileThreshold)
    ) {
