            ...
            <section>
                <Stack direction="column" gap="20px">
                    ...
                    <Stack width="100%" gap="5%" alignHorizontalContent="center" collapseAtWidth="1000px">
                        <Stack direction="column" className="secondaryBG" gap="8px" style={{padding: '10px', borderRadius: 'var(--defaultBorderRadius)'}}>
                            <p>id: {params.id}</p>
                    ...
                    <Stack alignHorizontalContent="center">
                        <textarea className="secondaryBG" readOnly={true} style={{ width: '80%', padding: '10px', borderRadius: 'var(--defaultBorderRadius)', height: '80vh' }} contentEditable>
                            {work.textContent}
                        </textarea>
                    </Stack>
                </Stack>
